  ...
  return (
    <div className=" flex bg-[#F7F6F1] h-screen">
      ...
      <div className=" w-1/2 flex flex-col justify-center items-center">
        ...
        <img src={Logo} alt="" />
        <p className=" text-[#406C64] text-end text-xl mr-4">Hi, welcome back !</p>
        {/* input */}
        <div className=" flex flex-col">
          {/* email */}
          <p className="text-[#406C64] text-lg">Email</p>
          <input type="text" className=" border border-[#406C64] rounded-2xl bg-transparent mb-6 px-4 py-1.5" style={{}}/>
          ...
          <div className="text-center">
            ...
            <a href="/register" to="" className="text-[#406C64] font-semibold">
              SIGN UP
            </a>
          </div>
        </div>
